...
import 'package:DDatFlutter/common/net/graphql/client.dart';
import 'package:DDatFlutter/common/net/transformer.dart';
import 'package:DDatFlutter/db/provider/repos/read_history_db_provider.dart';
import 'package:DDatFlutter/db/provider/repos/repository_commits_db_provider.dart';
import 'package:DDatFlutter/db/provider/repos/repository_detail_db_provider.dart';
import 'package:DDatFlutter/db/provider/repos/repository_detail_readme_db_provider.dart';
import 'package:DDatFlutter/db/provider/repos/repository_event_db_provider.dart';
import 'package:DDatFlutter/db/provider/repos/repository_fork_db_provider.dart';
import 'package:DDatFlutter/db/provider/repos/repository_star_db_provider.dart';
import 'package:DDatFlutter/db/provider/repos/repository_watcher_db_provider.dart';
import 'package:DDatFlutter/db/provider/repos/trend_repository_db_provider.dart';
import 'package:DDatFlutter/db/provider/user/user_repos_db_provider.dart';
import 'package:DDatFlutter/db/provider/user/user_stared_db_provider.dart';
import 'package:DDatFlutter/common/config/config.dart';
import 'package:DDatFlutter/common/dao/dao_result.dart';
import 'package:DDatFlutter/model/Branch.dart';
import 'package:DDatFlutter/model/Event.dart';
import 'package:DDatFlutter/model/FileModel.dart';
import 'package:DDatFlutter/model/PushCommit.dart';
import 'package:DDatFlutter/model/Release.dart';
import 'package:DDatFlutter/model/RepoCommit.dart';
import 'package:DDatFlutter/model/Repository.dart';
import 'package:DDatFlutter/model/RepositoryQL.dart';
import 'package:DDatFlutter/model/TrendingRepoModel.dart';
import 'package:DDatFlutter/model/User.dart';
import 'package:DDatFlutter/common/net/address.dart';
import 'package:DDatFlutter/common/net/api.dart';
import 'package:DDatFlutter/common/net/trending/github_trending.dart';
...
class ReposDao {
  ...
  static getNewsVersion(context, showTip) async {
    ...
    var res = await getRepositoryReleaseDao("CarGuo", 'DDatFlutter', 1,
        needHtml: false);
    if (res != null && res.result && res.data.length > 0) {

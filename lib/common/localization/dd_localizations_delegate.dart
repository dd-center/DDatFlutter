...
class DDLocalizationsDelegate extends LocalizationsDelegate<GSYLocalizations> {

  DDLocalizationsDelegate();
  ...
  ///全局静态的代理
  static DDLocalizationsDelegate delegate = new DDLocalizationsDelegate();
}
